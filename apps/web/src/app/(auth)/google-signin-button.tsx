/**
 * Botão "Continuar com o Google" — segue as diretrizes oficiais de marca:
 * https://developers.google.com/identity/branding-guidelines
 *
 * Regras seguidas: logo "G" oficial de 4 cores sem alteração de forma/cor,
 * área de proteção do logo, altura mínima 40px, texto Roboto/Arial 14px
 * medium com letter-spacing 0.25px, variante "Dark" (combina com o tema
 * escuro do produto) nas cores exatas do guia (#131314 fundo, #8E918F
 * borda, #E3E3E3 texto).
 */
